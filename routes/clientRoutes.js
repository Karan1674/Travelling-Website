...
router.get('/user-booking/:bookingId', isAuthenticated, getPackageBookingDetails);
...
router.get('/user-product-bookings', isAuthenticated, getUserProductBookings);
router.get('/productBooking-detail/:id', isAuthenticated, renderProductBookingDetails);
